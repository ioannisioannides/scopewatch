...
"""
Tests for the certification_bodies app.

This module contains tests for models, views, and forms in the certification_bodies app.
"""
...
class CertBodyViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.cert_body_user = CertBodyUser.objects.create(
            user=self.user, cert_body=self.cert_body, role="admin", is_active=True
        )
        self.client = Client()
        # Create organization for audits
        self.organization = Organization.objects.create(
            name="Test Organization", industry="Manufacturing", is_active=True
        )
