...
This module contains extensive tests for the Organizations app's API views, serializers,
and URLs to improve test coverage.
"""
...
from .models import Organization, Certification, OrganizationUser
...
class OrganizationAPIPermissionsTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.organization_detail_url = reverse(
            'organizations-api:organization-detail', 
...
class CertificationAPIViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.certification_detail_url = reverse(
            'organizations-api:certification-detail',
            args=[self.certification.pk]
        )
